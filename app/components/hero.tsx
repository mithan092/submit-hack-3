...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row h-screen w-[1340px] px-[80px] py-[60px] ">
      ...
      <div className="flex-1 relative bg-[#2A254B]">
        <Image
          src="/acess/hero pic.jpg" // Change this to your correct image path
